...
API backend para plataforma escolar, desenvolvida com AdonisJS, autenticação, banco relacional e validacoes de dominio.
...
- Autenticacao.
- Gestao de cursos e usuarios.
- Validacoes com VineJS.
- Migrations e seed.
- Testes.
- API estruturada por controllers.
...
```bash
git clone https://github.com/marquesmaycon/dot-school-api.git
cd dot-school-api
npm install
npm run dev
```
...
- Backend educacional com estrutura robusta.
- Boa demonstracao de AdonisJS.
- Pronto para parear com o frontend Dot School.

## Repositorio

[Acessar repositorio no GitHub](https://github.com/marquesmaycon/dot-school-api)
